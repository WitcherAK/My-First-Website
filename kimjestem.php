...
<!-- boczny panel -->
    ...
    ~ Linus Pauling
		...
		<div class='square'>
			<div class='title5'>
				<div class='square2'>
					<img src="photo/me.jpg" height="179.5" width="132" />
				</div>
				
				&nbsp; Nazywam się Roland Górnisiewicz, mieszkam w Krakowie, mam 21 lat. </br>
				Studiuję kierunek Automatyka i Robotyka na uczelni Akademia Górniczo - Hutnicza.   
				Moją pasją jest zdobywanie wiedzy na temat różnych języków używanych przez komputer czy internet. Chciałbym kontynuować swoją karierę w dziedzinie budowy aplikacji, Front-end lub programowania w języku C++ lub Python.
				</br>
				W wolnym czasie zażywam świeżego powietrza na wrotkach lub rolkach.
