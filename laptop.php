...
<head>
	...
	<link rel='stylesheet' href='css/freestyle.css' type="text/css"/><!-- do zabawy z backgroundem musi nadpisywac css plik-->
...
<!-- boczny panel -->
	...
	<div id='container'> 
		...
		<div class="square">
			...
			<div style="clear:both"></div>
			<div class=title4>
				<p><i>"Najlepszym sposobem, by wpaść na dobry pomysł jest... </br> mieć wiele pomysłów.   " </i>
    ~ Linus Pauling </p>
			</div>			
		</div>
		<div class='square'>
			<div class='title5'>
				<div id='zanikanie'>
				<p>strona w permanentnej budowie</p><span></span>
				</div>
			</div>
			<div class='fb'>
